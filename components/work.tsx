...
export const WorkLeft: React.FC<{ progress: number; children: any }> = ({
  ...
  return (
    <div
      className="flex flex-col items-center justify-center text-3xl pl-4 lg:text-3xl h-[30vh] lg:h-auto"
      style={{
...
export const WorkRight: React.FC<{ progress: number; children: any }> = ({
  ...
  return (
    <div
      className="flex flex-1 lg:items-center justify-center h-screen drop-shadow-[0_6px_5px_rgba(0,0,0,0.4)]"
      style={{
        transform: `translateY(${translateY}px)`,
      }}
    >
