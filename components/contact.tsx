  ...
  const handleSubmit = useCallback(
    (e: any) => {
      ...
      axios({
        ...
        handleServerResponse(true, "Gracias, Tu mensaje fue enviado");
      });
    },
  ...
  return (
    <div className="bg-black text-white flex flex-col justify-center items-center pt-10 min-h-screen">
      ...
      >
        ...
        {status.submitted ? (
          <div
            className="text-white ext-xl font-bold px-4 py-3 rounded relative"
            role="alert"
          >
            Tu mensaje fue enviado correctamente. Pronto nos pondremos en
            contacto
          </div>
        ) : (
          <>
