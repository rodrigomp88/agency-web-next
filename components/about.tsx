    ...
    <section className={`flex flex-col bg-white py-20 text-3xl md:text-4xl`}>
      <div className="container mx-auto px-11">
        <p className="leading-tight max-w-5xl mx-auto text-3xl lg:text-4xl tracking-tight">
          <strong>
            Te ayudamos a construir aplicaciones web, mas rapido, mejores y
            modernas.
          </strong>{" "}
          Nuestro equipo de expertos e ingenieros ha creado la mejor experiencia
          de usuario en algunas de las aplicaciones web mas populares de hoy en
          dia
        </p>
      </div>
      <div className="container mx-auto px-21 text-center mt-28">
        <h2>Nuestro Equipo</h2>
        <div className="mt-2">Los &ldquo;desarrolladores especiales&rdquo;</div>
